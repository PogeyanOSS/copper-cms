...
public final class MimeUtils {
	...
	static {
		...
		// application/futuresplash isn't IANA, so application/x-futuresplash
		// should come first.
		...
		// Video mime types for 3GPP first so they'll be default for
		...
		// add ".mp3" first so it will be the default for
		...
		add("image/ico", "ico");
		add("image/ief", "ief");
		// add ".jpg" first so it will be the default for
		// guessExtensionFromMimeType
		add("image/jpeg", "jpg");
		add("image/jpeg", "jpeg");
		add("image/jpeg", "jpe");
