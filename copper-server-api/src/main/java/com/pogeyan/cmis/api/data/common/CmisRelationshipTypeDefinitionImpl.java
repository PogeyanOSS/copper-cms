...
public class CmisRelationshipTypeDefinitionImpl extends TypeDefinitionImpl implements RelationshipTypeDefinition {

	private static final long serialVersionUID = 1L;
	private List<String> allowedSourceTypeIds;
	private List<String> allowedTargetTypeIds;
