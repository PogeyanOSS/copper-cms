...
public class ErrorMessages {
	...
	public static String NO_OBJECT_ID = "No object ids provided";
	public static String SOURCE_NO_TYPE = "Source object has no type";
	public static String PROPERTIES_NULL = "Properties are null";
	public static String ACCESS_DENIED = "%s, does not have valid access control permission to access this object";
	public static String OBJECT_ID_NULL = "Object Id should not be null";
	public static String OBJECTID_MUST_BE_SET = "object Id must be set";
	public static String OBJECT_INFOIMPL_NULL = "ObjectInfoImpl instance must not be null";
	public static String CANNOT_CREATE_FOLDER = "Cannot create a folder without a name";
	public static String ERROR = "error: %s";
	public static String CANNOT_CREATE_FOLDER_WITH_NON_FOLDER = "Cannot create a folder, with a non-folder type: %s";
	public static String UNKNOWN_PARENT = "Parent is unknown";
	public static String FOLDER_PRESENT = "%s, is already present";
	public static String PROPERTIES_MUST_BE_SET = "Properties must be set";
	public static String CANNOT_CREATE_DOCUMENT = "Cannot create a document without a name";
	public static String TYPE_MUST_BE_DOCUMENT_TYPE = "Type must be a document type";
	public static String CANNOT_CREATE_ITEM = "Cannot create a item without a name";
	public static String ITEM_PRESENT = "%s, is already present";
	public static String CANNOT_CREATE_RELATIONSHIP = "Cannot create a relationship without a relation_name";
	public static String CANNOT_CREATE_RELATIONSHIP_WITHOUT_SOURCEID = "Cannot create a relationship without a sourceId";
	public static String CANNOT_CREATE_RELATIONSHIP_WITHOUT_TARGETID = "Cannot create a relationship without a targetId";
	...
	public static String POLICY_PRESENT = "%s, is already present";
	public static String UPDATE_FAILED = "update properties: no properties given for object id: %s";
	public static String CHANGETOKEN_DOESNT_MATCH = "updateProperties failed: changeToken does not match";
	public static String SET_CONTENT_FAILED = "set content failed: changeToken does not match";
	public static String DELETE_CONTENT_FAILED = "delete content failed: changeToken does not match";
	public static String OBJECT_NOT_FOUND = "Object not found";
	public static String DELETE_OBJECT_FAILED = "can't delete a root folder";
	public static String CANNOT_DELETE = "deleteTree cannot delete object with id: %s";
	public static String CANNOT_BE_INVOKED = "deleteTree can only be invoked on a folder";
	public static String DOESNT_SUPPORT = "This repository does not support unfile operations";
	public static String NO_MOVE_OPERATION = "RootFolder have no move operation";
	public static String UNKNOWN_TARGET_FOLDER = "Unknown target folder";
	public static String DESTINATION_MUST_BE_FOLDER = "Destination of a move operation must be a folder";
	public static String UNKNOWN_SOURCE_FOLDER = "Unknown source folder";
	public static String DESTINATION_NOT_A_PARENT_FOLDER = "Destination is not a parent folder for this document";
	public static String MOVE_OBJECT_FAILED = "move object failed";
	public static String MOVE_MUST_BE_FOLDER = "sourceFolderId of a move operation must be a folder";
	public static String NO_PROPERTIES = "No properties";
	public static String UNKNOWN_PROPERTY = "property is unknown";
	public static String SESSION_NULL = "Error: Session is null";
