...
public abstract class MessageReference {
   ...
   */
  public static MessageReference create(final Class<? extends Throwable> clazz, final String key) {
   ...
   */
  public static MessageReference createMessageReference(final Class<? extends Exception> clazz,
