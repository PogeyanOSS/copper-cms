...
public final class POSTHttpServletRequestWrapper extends QueryStringHttpServletRequestWrapper {
	...
	public POSTHttpServletRequestWrapper(HttpServletRequest request) throws IOException, FileUploadException {
		super(request);
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			...
			this.requestBody = request.getReader().lines().collect(Collectors.joining("\n"));
		}
	}
