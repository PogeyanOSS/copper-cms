...
public abstract class AbstractRunner {
    ...
    public static final String BROWSER_URL="http://localhost:8080/MongoTest/";
    ...
    public void setParameters(Map<String, String> orgParameters) {
        ...
        orgParameters=new HashMap<String, String>();
        orgParameters.put(SessionParameter.USER, USER_NAME);
        orgParameters.put(SessionParameter.PASSWORD, PASSWORD);
        orgParameters.put(SessionParameter.BROWSER_URL, BROWSER_URL);
        orgParameters.put(SessionParameter.BINDING_TYPE, BindingType.BROWSER.value());
        orgParameters.put(SessionParameter.REPOSITORY_ID,REPOSITORY_ID);
