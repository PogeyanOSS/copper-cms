...
public class VerSmokeForCustomTypeTestWithoutContentStream extends AbstractSessionTest {

	@Override
	public void init(Map<String, String> parameters) {
		super.init(parameters);
		setName("Versioning Smoke For Custom Type Test without ContentStream");
		setDescription(
	...
	public void run(Session session) {
		...
		try {
			...
			Document doc = testFolder.createDocument(getProperties("versiondeletetest", docType), null, null, null,
