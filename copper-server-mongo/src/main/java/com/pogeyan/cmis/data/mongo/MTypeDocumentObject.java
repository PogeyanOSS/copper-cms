...
public class MTypeDocumentObject extends MTypeObject implements DocumentTypeDefinition {
	...
	public MTypeDocumentObject() {

	}

	public MTypeDocumentObject(String id, String localName, String localNamespace, String displayName, String queryName,
