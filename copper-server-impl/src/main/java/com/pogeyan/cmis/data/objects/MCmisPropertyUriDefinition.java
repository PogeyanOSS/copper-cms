...
public class MCmisPropertyUriDefinition implements PropertyUriDefinition {
	...
	public MCmisPropertyUriDefinition() {
		super();
	}

	public MCmisPropertyUriDefinition(MPropertyDefinition<?> type) {
		super();
		this.id = type.getId();
