...
public class MCmisPropertyBooleanDefinition implements PropertyBooleanDefinition {
	...
	public MCmisPropertyBooleanDefinition() {
		super();
	}

	public MCmisPropertyBooleanDefinition(MPropertyDefinition<?> type) {
		super();
		this.id = type.getId();
