...
public class MCmisPropertyStringDefinition implements PropertyStringDefinition {
	...
	public MCmisPropertyStringDefinition() {
		super();
	}

	public MCmisPropertyStringDefinition(MPropertyDefinition<?> type) {
		super();
		this.id = type.getId();
