...
public class TokenList implements Iterator<Token> {
	 ...
	 * 
	 * @param position
	 *            Position of parsed token
	 * @param kind
	 *            Kind of parsed token
	 * @param uriLiteral
	 *            String value of parsed token
	 */
	 ...
	 *            Kind of parsed token
	 * @param javaLiteral
	 *            EdmLiteral of parsed token containing type and value of
	 *            UriLiteral
	 */
	public void appendEdmTypedToken(final int position, final TokenKind kind, final String uriLiteral, final ObjectLiteral objectLiteral) {
		Token token = new Token(kind, position, uriLiteral, objectLiteral);
		tokens.add(token);
		return;
	}
