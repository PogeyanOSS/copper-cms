 ...
 * 
 */
public class TokenizerException extends BaseUriException {
  ...
  static public TokenizerException createTYPEDECTECTION_FAILED_ON_STRING(final BaseUriException ex,
