	...
	public static class Impl {
		...
		public static String addRootFolder(String repositoryId, String userName, String typeId, String tracingId,
			...
			try {
				...
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.EXCEPTION, e, span.getTraceId()),
		...
		public static ObjectData getObject(String repositoryId, String objectId, String filter,
			...
			if (objectId == null && filter == null) {
				LOG.error("getObject objectId and filter is null in repository: {}, TraceId: {}", repositoryId,
						span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECT_ID_NULL, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(String.format(ErrorMessages.OBJECT_ID_NULL, span.getTraceId()));
			} else if (objectId == null) {
				LOG.error("getObject objectId is null in repository: {}, TraceId: {}", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECT_ID_NULL, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(String.format(ErrorMessages.OBJECT_ID_NULL, span.getTraceId()));
			}
			...
			if (data == null) {
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECT_NULL, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(String.format(ErrorMessages.OBJECT_NULL, span.getTraceId()));
			}
		...
		public static ObjectData getObjectByPath(String repositoryId, String path, String filter,
			...
			if (path == null && filter == null) {
				LOG.error("getObjectByPath unknown object id: {}, repository: {}, TraceId: {}", path, repositoryId,
						span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECTID_MUST_BE_SET, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.OBJECTID_MUST_BE_SET, span.getTraceId()));
			}
		...
		public static Properties compileProperties(String repositoryId, IBaseObject data, Set<String> orgfilter,
			...
			if (data == null) {
				...
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(String.format(ErrorMessages.OBJECT_NULL, span.getTraceId()));
			}
			...
			if (objectInfo == null) {
				LOG.error("compileProperties ObjectInfoImpl is null in: {} repository!, TraceId: {}", repositoryId,
						span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECT_INFOIMPL_NULL, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(
						String.format(ErrorMessages.OBJECT_INFOIMPL_NULL, span.getTraceId()));
			}
			...
			try {
				...
				TypeDefinition type = CmisTypeServices.Impl.getTypeDefinition(repositoryId, typeId, null, userObject, tracingId, span);
				// id
				...
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisRuntimeException(String.format(ErrorMessages.EXCEPTION, e, span.getTraceId()));
			}
		}
		...
		private static IBaseObject createFolderIntern(String repositoryId, String folderId, Properties properties,
			...
			if (folderName == null || folderName.length() == 0) {
				LOG.error("createFolderIntern unknown folder name: {}, repositoryId: {}, TraceId: {}", folderName,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_CREATE_FOLDER, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_FOLDER, span.getTraceId()));
			}

			// check name syntax
			if (!NameValidator.impl.isValidName(folderName)) {
				LOG.error("createFolderIntern error: {}, : {}, repositoryId: {}, TraceId: {}",
						NameValidator.ERROR_ILLEGAL_NAME, folderName, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.ERROR, NameValidator.ERROR_ILLEGAL_NAME, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.ERROR, NameValidator.ERROR_ILLEGAL_NAME, span.getTraceId()));
			...
			if (typeDef == null) {
				LOG.error("Method name: {}, unknown typeId: {}, repositoryId: {}, TraceId: {}", "createFolder", typeDef,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_TYPE_ID, typeId, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(
						String.format(ErrorMessages.UNKNOWN_TYPE_ID, typeId, span.getTraceId()));
			}
			...
			if (!typeDef.getBaseTypeId().equals(BaseTypeId.CMIS_FOLDER)) {
				LOG.error(
						...
						typeDef.getId(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService()
						.updateSpan(span,
								TracingMessage.message(
										String.format(ErrorMessages.CANNOT_CREATE_FOLDER_WITH_NON_FOLDER,
												typeDef.getId(), span.getTraceId()),
										ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(String.format(ErrorMessages.CANNOT_CREATE_FOLDER_WITH_NON_FOLDER,
						typeDef.getId(), span.getTraceId()));
			}
			...
			if (parent == null) {
				LOG.error("createFolderIntern parent is unknown: {}, repositoryId: {}, TraceId: {}", parent,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_PARENT, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(String.format(ErrorMessages.UNKNOWN_PARENT, span.getTraceId()));
			}
			...
			if (!isVirtual) {
				...
				try {
					...
					LOG.error(
							...
							"cmisObjectService", "createFolderIntern", repositoryId, e, span.getTraceId());
					TracingApiServiceFactory.getApiService().updateSpan(span,
							TracingMessage.message(String.format(ErrorMessages.EXCEPTION, e, span.getTraceId()),
									ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
					TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
					throw new IllegalArgumentException(String.format(ErrorMessages.EXCEPTION, e, span.getTraceId()));
				}
			}
		...
		private static IBaseObject createFolderObject(String repositoryId, IBaseObject parentData, String objectId,
			...
			if (folderObject != null) {
				LOG.error("createFolderObject already present FolderObject:{}, repositoryId: {}, TraceId: {}",
						folderObject.getId(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(folderName, ErrorMessages.FOLDER_PRESENT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(
						String.format(String.format(folderName, ErrorMessages.FOLDER_PRESENT, span.getTraceId())));
			}
		...
		private static IDocumentObject createDocumentIntern(String repositoryId, Properties properties, String folderId,
			...
			if (properties == null || properties.getProperties() == null) {
				LOG.error("createDocumentIntern unknown properties: {}, repositoryId: {}, TraceId: {}", properties,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.PROPERTIES_MUST_BE_SET, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.PROPERTIES_MUST_BE_SET, span.getTraceId()));
			}
			...
			if (documentName == null || documentName.length() == 0) {
				LOG.error("createDocumentIntern unknown document name, repositoryId: {}, TraceId: {}", repositoryId,
						span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_CREATE_DOCUMENT, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_DOCUMENT, span.getTraceId()));
			}
			...
			if (!NameValidator.impl.isValidName(documentName)) {
				LOG.error("createDocumentIntern error: {}, : {}, repositoryId: {}, TraceId: {}",
						NameValidator.ERROR_ILLEGAL_NAME, documentName, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.ERROR, NameValidator.ERROR_ILLEGAL_NAME, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
			...
			if (typeDef == null) {
				LOG.error("Method name : {}, unknown typeId: {}, repositoryId: {}, TraceId: {}", "createDocument",
						typeDef, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_TYPE_ID, typeId, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
			...
			if (typeDef.getBaseTypeId() != BaseTypeId.CMIS_DOCUMENT) {
				LOG.error("createDocumentIntern Type: {} is not a document type!, repositoryId: {}, TraceId: {}",
						typeDef.getBaseTypeId(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.TYPE_MUST_BE_DOCUMENT_TYPE, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.TYPE_MUST_BE_DOCUMENT_TYPE, span.getTraceId()));
			...
			if (parent == null) {
				...
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_PARENT, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(String.format(ErrorMessages.UNKNOWN_PARENT, span.getTraceId()));
			}
			...
			if (contentStream != null) {
				try {
					...
					LOG.error("createDocumentIntern file creation exception: {}, repositoryId: {}, TraceId: {}", ex,
							repositoryId, span.getTraceId());
					TracingApiServiceFactory.getApiService().updateSpan(span,
							TracingMessage.message(String.format(ErrorMessages.EXCEPTION, ex, span.getTraceId()),
									ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
					TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
					throw new IllegalArgumentException(String.format(ErrorMessages.EXCEPTION, ex, span.getTraceId()));
				}
			}
		...
		public static String createDocumentFromSource(String repositoryId, String sourceId, Properties properties,
			...
			if (properties == null || properties.getProperties() == null) {
				...
				properties = CmisPropertyConverter.Impl.createNewProperties(pros, repositoryId, userObject, tracingId, span);
			}
			PropertyData<?> pdType = properties.getProperties().get(PropertyIds.OBJECT_TYPE_ID);
			String objectTypeId = (String) pdType.getFirstValue();
			...
			if (null == documentName || documentName.length() == 0) {
				LOG.error("createDocumentFromSource unknown document name: {}, repositoryId: {}, TraceId: {}",
						documentName, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_CREATE_DOCUMENT, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
			...
			if (typeDef == null) {
				LOG.error("Method name: {}, unknown typeId: {}, repositoryId: {}, TraceId: {}",
						"createDocumentFromSource", typeDef, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_TYPE_ID, typeId, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
		...
		private static IBaseObject createItemIntern(String repositoryId, Properties properties, String folderId,
			...
			if (null == itemName || itemName.length() == 0) {
				LOG.error("createItemIntern unknown item name: {}, repositoryId: {}, TraceId: {}", itemName,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_CREATE_ITEM, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_ITEM, span.getTraceId()));
			}

			// check name syntax
			if (!NameValidator.impl.isValidName(itemName)) {
				LOG.error("createItemIntern error: {}, : {}, repositoryId: {}, TraceId: {} ",
						NameValidator.ERROR_ILLEGAL_NAME, itemName, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.ERROR, NameValidator.ERROR_ILLEGAL_NAME, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
		...
		private static IBaseObject createItemObject(String repositoryId, IBaseObject parentData, String objectId,
			...
			if (itemObject != null) {
				LOG.error("createItemObject object id already present: {}, repositoryId: {}, TraceId: {}",
						itemObject.getId(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.ITEM_PRESENT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(String.format(ErrorMessages.ITEM_PRESENT, span.getTraceId()));
			}
		...
		private static IBaseObject createRelationshipIntern(String repositoryId, String folderId, Properties properties,
			...
			if (relationTypeProperty == null) {
				LOG.error("Create relationship exception: {}, repositoryId: {}, TraceId: {}",
						"cannot create a relationship without a relation_name.", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP, span.getTraceId()));
			...
			if (pd == null) {
				LOG.error("Create relationship exception: {}, repositoryId: {}, TraceId: {}",
						"cannot create a relationship without a sourceId.", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span, TracingMessage.message(
						String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP_WITHOUT_SOURCEID, span.getTraceId()),
						ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP_WITHOUT_SOURCEID, span.getTraceId()));
			...
			if (pd == null) {
				LOG.error("Create relationship exception: {}, repositoryId: {}, TraceId: {}",
						"cannot create a relationship without a targetId.", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span, TracingMessage.message(
						String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP_WITHOUT_TARGETID, span.getTraceId()),
						ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP_WITHOUT_TARGETID, span.getTraceId()));
			...
			if (!typeId.equalsIgnoreCase(CustomTypeId.CMIS_EXT_RELATIONSHIP.value())) {
				LOG.error("Create relationship typeId must use cmis base type: {}, repositoryId: {}, TraceId: {}",
						CustomTypeId.CMIS_EXT_RELATIONSHIP.value(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.TYPEID_MUST_USE_BASE_TYPE,
										CustomTypeId.CMIS_EXT_RELATIONSHIP.value(), span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(String.format(ErrorMessages.TYPEID_MUST_USE_BASE_TYPE,
								CustomTypeId.CMIS_EXT_RELATIONSHIP.value(), span.getTraceId())));
			...
			if (!typeDef.getBaseTypeId().equals(BaseTypeId.CMIS_RELATIONSHIP)) {
				...
				throw new CmisInvalidArgumentException(String.format(
						ErrorMessages.CANNOT_CREATE_RELATIONSHIP_WITH_NON_RELATIONSHIP_TYPE, span.getTraceId()));
			}
			...
			if (sourceTypeId == null) {
				LOG.error("Create relationship exception: {}, repositoryId: {}, TraceId: {}",
						"wrong sourceId,SourceObject should not be null", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.WRONG_SOURCEID, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(String.format(ErrorMessages.WRONG_SOURCEID, span.getTraceId()));
			}
			if (targetTypeId == null) {
				LOG.error("Create relationship exception: {}, repositoryId: {}, TraceId: {}",
						"wrong targetId,TargetObject should not be null", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.WRONG_TARGETID, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(String.format(ErrorMessages.WRONG_TARGETID, span.getTraceId()));
			}
			...
			if (pd == null) {
				LOG.error("Create relationship exception: {}, repositoryId: {}, TraceId: {}",
						"cannot create a relationship without a Name.", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.CANNOT_CREATE_RELATIONSHIP, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
		...
		private static IBaseObject createRelationshipObject(String repositoryId, IBaseObject parentData, String name,
			...
			if (result.equals(null)) {
				LOG.error("createRelationshipObject unknown relation object: {}, repositoryId: {}, TraceId: {}", result,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.IMPOSSIBLE_CREATE_FOLDER, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(
						String.format(ErrorMessages.IMPOSSIBLE_CREATE_FOLDER, span.getTraceId()));
			}
			...
			if (itemObject != null) {
				LOG.error("Relationship object already present: {}, repositoryId: {}, TraceId: {}", itemObject.getId(),
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(typeId, ErrorMessages.TYPE_ID_PRESENT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(
						String.format(typeId, ErrorMessages.TYPE_ID_PRESENT, span.getTraceId()));
			}
		...
		private static void validateRelationshipDocuments(String repositoryId, String relationName, String sourceTypeId,
			...
			if (sourceTable == null) {
				LOG.error("SourceTable  not present in relationship object: {}, repositoryId: {}, TraceId: {}",
						sourceTable, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.SOURCETABLE_NOT_PRESENT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(
						String.format(ErrorMessages.SOURCETABLE_NOT_PRESENT, span.getTraceId()));
			}
			...
			if (targetTable == null) {
				LOG.error("target table  not present in relationship object: {}, repositoryId: {}, TraceId: {}",
						sourceTable, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.TARGETTABLE_NOT_PRESENT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(
						String.format(ErrorMessages.TARGETTABLE_NOT_PRESENT, span.getTraceId()));
			}
			if (!sourceTable.equalsIgnoreCase(sourceTypeId)) {
				...
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.WRONG_RELATIONSHIP_OBJECT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(
						String.format(ErrorMessages.WRONG_RELATIONSHIP_OBJECT, span.getTraceId()));
		...
		private static IBaseObject createPolicyIntern(String repositoryId, Properties properties, String folderId,
			...
			if (null == policyName || policyName.length() == 0) {
				LOG.error("createPolicyIntern unknown policy name: {}, repositoryId: {}, TraceId: {}", policyName,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_CREATE_POLICY, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_CREATE_POLICY, span.getTraceId()));
			}
			if (!NameValidator.impl.isValidName(policyName)) {
				LOG.error("createPolicyIntern error: {}, : {}, repositoryId: {}, TraceId: {}",
						NameValidator.ERROR_ILLEGAL_NAME, policyName, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.ERROR, NameValidator.ERROR_ILLEGAL_NAME, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
			...
			if (!typeDef.getBaseTypeId().equals(BaseTypeId.CMIS_POLICY)) {
				...
				TracingApiServiceFactory.getApiService()
						.updateSpan(span,
								TracingMessage.message(
										String.format(ErrorMessages.CANNOT_CREATE_POLICY_WITH_NON_FOLDER,
												typeDef.getId(), span.getTraceId()),
										ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(String.format(ErrorMessages.CANNOT_CREATE_POLICY_WITH_NON_FOLDER,
						typeDef.getId(), span.getTraceId()));
			}
			PropertiesImpl props = compileWriteProperties(repositoryId, typeDef, userObject, properties, null,
					tracingId, span);
		...
		private static IBaseObject createPolicyObject(String repositoryId, IBaseObject parentData, String objectId,
			...
			if (policyObject != null) {
				LOG.error("createPolicyObject policy Object already present: {}, repositoryId: {}, TraceId: {}",
						policyObject.getName(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.POLICY_PRESENT, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(String.format(ErrorMessages.POLICY_PRESENT, span.getTraceId()));
			}
			...
			for (BulkUpdateObjectIdAndChangeToken obj : objectIdAndChangeToken) {
				...
				try {
					...
					LOG.error(
							...
							obj.getId(), e, repositoryId, span.getTraceId());
					TracingApiServiceFactory.getApiService().updateSpan(span,
							TracingMessage.message(
									String.format(ErrorMessages.EXCEPTION, e.toString(), span.getTraceId()),
		...
		public static void updateProperties(String repositoryId, Holder<String> objectId, Holder<String> changeToken,
			...
			if (properties == null) {
				LOG.error("Method name: {}, no properties given for object id: {}, repositoryId: {}, TraceId: {}",
						"updateProperties", id, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.UPDATE_FAILED, objectId.getValue(), span.getTraceId()),
								ErrorMessages.RUNTIME_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
			...
			if (changeToken != null && changeToken.getValue() != null
				...
				LOG.error("updateProperties failed: changeToken does not match: {}, repositoryId: {},  TraceId: {}",
						changeToken, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CHANGETOKEN_DOESNT_MATCH, span.getTraceId()),
								ErrorMessages.UPDATE_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisUpdateConflictException(
						String.format(ErrorMessages.CHANGETOKEN_DOESNT_MATCH, span.getTraceId()));
			}
			...
			if (customData != null && customData.getId().equalsIgnoreCase(PropertyIds.NAME)) {
				...
				if (data.getBaseId() == BaseTypeId.CMIS_FOLDER) {
					try {
						...
						TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
						throw new IllegalArgumentException(
								String.format(ErrorMessages.EXCEPTION, e, span.getTraceId()));
					}
		...
		public static void setContentStream(String repositoryId, Holder<String> objectId, Boolean overwrite,
			...
			if (changeToken != null && changeToken.getValue() != null
				...
				LOG.error("set content failed changeToken does not match: {}, repositoryId: {}, TraceId: {}",
						changeToken, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.SET_CONTENT_FAILED, span.getTraceId()),
								ErrorMessages.UPDATE_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisUpdateConflictException(
						String.format(ErrorMessages.SET_CONTENT_FAILED, span.getTraceId()));
			}
			Map<String, Object> updateProps = new HashMap<String, Object>();
		...
		public static void deleteContentStream(String repositoryId, Holder<String> objectId, Holder<String> changeToken,
			...
			if (changeToken != null && changeToken.getValue() != null
				...
				LOG.error("delete content failed: changeToken does not match in repositoryId: {}, TraceId: {}",
						changeToken, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.DELETE_CONTENT_FAILED, span.getTraceId()),
								ErrorMessages.UPDATE_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisUpdateConflictException(
						String.format(ErrorMessages.DELETE_CONTENT_FAILED, span.getTraceId()));
			}
		...
		public static void deleteObject(String repositoryId, String objectId, Boolean allVersions,
			...
			try {
				...
				LOG.error("deleteObject object not found in repositoryId: {}, TraceId: {}", repositoryId,
						span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECT_NOT_FOUND, span.getTraceId()),
								ErrorMessages.UPDATE_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisUpdateConflictException(String.format(ErrorMessages.OBJECT_NOT_FOUND, span.getTraceId()));
			}
			if (data == null) {
			...
			if (data.getName().equalsIgnoreCase("@ROOT@")) {
				LOG.error("deleteObject failed: {}, repositoryId: {}, TraceId: {}", "can't delete a root folder.",
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.DELETE_OBJECT_FAILED, span.getTraceId()),
								ErrorMessages.NOT_SUPPORTED_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisNotSupportedException(
						String.format(ErrorMessages.DELETE_OBJECT_FAILED, span.getTraceId()));
			}
			Map<String, String> parameters = RepositoryManagerFactory.getFileDetails(repositoryId);
			IStorageService localService = StorageServiceFactory.createStorageService(parameters);
			...
			if (data == null) {
				...
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.OBJECT_NOT_FOUND, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(String.format(ErrorMessages.OBJECT_NOT_FOUND, span.getTraceId()));
			}
		...
		public static FailedToDeleteData deleteTree(String repositoryId, String folderId, Boolean allVers,
			...
			if (data == null) {
				LOG.error("deleteTree cannot delete object with id: {}, {}, repositoryId: {}, TraceId: {}", folderId,
						"Object does not exist.", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_DELETE, folderId, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_DELETE, folderId, span.getTraceId()));
			}
			...
			if (!(data.getBaseId() == BaseTypeId.CMIS_FOLDER)) {
				...
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.CANNOT_BE_INVOKED, span.getTraceId()),
								ErrorMessages.INVALID_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						String.format(ErrorMessages.CANNOT_BE_INVOKED, span.getTraceId()));
			}

			if (unfileObjects == UnfileObject.UNFILE) {
				LOG.error("deleteTree: {}, repositoryId: {}, TraceId: {}",
						" This repository does not support unfile operations.", repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.DOESNT_SUPPORT, span.getTraceId()),
								ErrorMessages.NOT_SUPPORTED_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisNotSupportedException(String.format(ErrorMessages.DOESNT_SUPPORT, span.getTraceId()));
			}
		...
		public static ObjectData moveObject(String repositoryId, Holder<String> objectId, String targetFolderId,
			...
			if (data == null) {
				...
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.UNKNOWN_OBJECT, objectId.getValue(), span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(
						String.format(ErrorMessages.UNKNOWN_OBJECT, objectId.getValue(), span.getTraceId()));
			...
			if (data.getName().equalsIgnoreCase("@ROOT@")) {
				LOG.error("moveObject rootFolder: {}, have no move operation: {}, repositoryId: {}, TraceId: {}",
						data.getId(), objectId.getValue(), repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.NO_MOVE_OPERATION, span.getTraceId()),
								ErrorMessages.NOT_SUPPORTED_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisNotSupportedException(String.format(ErrorMessages.NO_MOVE_OPERATION, span.getTraceId()));
			}
			...
			if (null == soTarget) {
				LOG.error("moveObject unknown target folder: {}, repositoryId: {}, TraceId: {}", targetFolderId,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_TARGET_FOLDER, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(
						String.format(ErrorMessages.UNKNOWN_TARGET_FOLDER, span.getTraceId()));
				...
				LOG.error("moveObject destination move operation must be a folder: {}, repositoryId: {}, TraceId: {}",
						targetFolderId, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(
								String.format(ErrorMessages.DESTINATION_MUST_BE_FOLDER, span.getTraceId()),
								ErrorMessages.NOT_SUPPORTED_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisNotSupportedException(
						String.format(ErrorMessages.DESTINATION_MUST_BE_FOLDER, span.getTraceId()));
			...
			if (null == soSource) {
				LOG.error("moveObject unknown source folder: {}, repositoryId: {}, TraceId: {}", sourceFolderId,
						repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_SOURCE_FOLDER, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(
						String.format(ErrorMessages.UNKNOWN_SOURCE_FOLDER, span.getTraceId()));
				...
				LOG.error("moveObject source move operation must be a folder:{}, TraceId: {}", sourceFolderId,
						span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.MOVE_MUST_BE_FOLDER, span.getTraceId()),
								ErrorMessages.NOT_SUPPORTED_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisNotSupportedException(
						String.format(ErrorMessages.MOVE_MUST_BE_FOLDER, span.getTraceId()));
			}
			...
			if (data.getBaseId() == BaseTypeId.CMIS_FOLDER || data.getBaseId() == BaseTypeId.CMIS_DOCUMENT) {
				if (data.getBaseId() == BaseTypeId.CMIS_DOCUMENT) {
					...
					if (!checkParent) {
						...
						TracingApiServiceFactory.getApiService().updateSpan(span,
								TracingMessage.message(
										String.format(ErrorMessages.DESTINATION_NOT_A_PARENT_FOLDER, span.getTraceId()),
										ErrorMessages.NOT_SUPPORTED_EXCEPTION, repositoryId, true));
						TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
						throw new CmisNotSupportedException(
								String.format(ErrorMessages.DESTINATION_NOT_A_PARENT_FOLDER, span.getTraceId()));
					...
					try {
						...
						// TracingApiServiceFactory.getApiService().updateSpan(span, true, "Move Object
						// failed!", attrMap);
						TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
					...
					try {
						...
						TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
						throw new IllegalArgumentException(
								String.format(ErrorMessages.EXCEPTION, ex, span.getTraceId()));
					}
				}
		...
		private static PropertiesImpl compileWriteProperties(String repositoryId, TypeDefinition type,
			...
			if (properties == null || properties.getProperties() == null) {
				LOG.error("Method name: {}, unknown properties: {}, repositoryId: {}, TraceId: {}",
						"compileWriteProperties", properties, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.NO_PROPERTIES, span.getTraceId()),
								ErrorMessages.ILLEGAL_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new IllegalArgumentException(String.format(ErrorMessages.NO_PROPERTIES, span.getTraceId()));
			}

			if (type == null) {
				LOG.error("Method name: {}, unknown typeId: {}, repositoryId: {}, TraceId: {}",
						"compileWriteProperties", type, repositoryId, span.getTraceId());
				TracingApiServiceFactory.getApiService().updateSpan(span,
						TracingMessage.message(String.format(ErrorMessages.UNKNOWN_TYPE_ID, type, span.getTraceId()),
								ErrorMessages.OBJECT_NOT_FOUND_EXCEPTION, repositoryId, true));
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisObjectNotFoundException(
						String.format(ErrorMessages.UNKNOWN_TYPE_ID, type, span.getTraceId()));
			}
			...
			for (PropertyData<?> prop : properties.getProperties().values()) {
				...
				if (propTypes == null) {
					LOG.error("Method name: {}, unknown propertiesTypes: {}, repositoryId: {}, TraceId: {}",
							"compileWriteProperties", prop.getId(), repositoryId, span.getTraceId());
					TracingApiServiceFactory.getApiService().updateSpan(span,
