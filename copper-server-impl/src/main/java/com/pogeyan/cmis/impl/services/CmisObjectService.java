	...
	public static class Impl {
		...
		public static void deleteObjectChildrens(String repositoryId, IBaseObject data, MBaseObjectDAO baseMorphiaDAO,
			...
			if (data.getBaseId() == BaseTypeId.CMIS_FOLDER) {
				...
				for (IBaseObject child : children) {
					...
					baseMorphiaDAO.delete(repositoryId, principalIds, child.getId(), forceDelete == null ? false : forceDelete, token,
							typeId);
				}
				localService.deleteFolder(data.getPath());
				baseMorphiaDAO.delete(repositoryId, principalIds, data.getId(), forceDelete == null ? false : forceDelete, token,
						typeId);
				...
				for (IDocumentObject document : versionedDocument) {
					...
					baseMorphiaDAO.delete(repositoryId, principalIds, document.getId(), forceDelete == null ? false : forceDelete,
							token, typeId);
		...
		public static FailedToDeleteData deleteTree(String repositoryId, String folderId, Boolean allVers,
			...
			for (IBaseObject child : children) {
				...
				baseMorphiaDAO.delete(repositoryId, principalIds, child.getId(), forceDelete == null ? false : forceDelete, token,
						child.getTypeId());
				IBaseObject childCheck = DBUtils.BaseDAO.getByObjectId(repositoryId, principalIds, true, child.getId(), null,
						child.getTypeId());
			...
			baseMorphiaDAO.delete(repositoryId, principalIds, folderId, forceDelete == null ? false : forceDelete, token,
					data.getTypeId());
		...
		public static ObjectData moveObject(String repositoryId, Holder<String> objectId, String targetFolderId,
			...
			IBaseObject soTarget = DBUtils.BaseDAO.getByObjectId(repositoryId, principalIds, true, targetFolderId, null,
					data.getTypeId());
			if (null == soTarget) {
			...
			Map<String, String> parameters = RepositoryManagerFactory.getFileDetails(repositoryId);
			IStorageService localService = StorageServiceFactory.createStorageService(parameters);
			IBaseObject soSource = DBUtils.BaseDAO.getByObjectId(repositoryId, principalIds, true, sourceFolderId, null,
					data.getTypeId());
			if (null == soSource) {
