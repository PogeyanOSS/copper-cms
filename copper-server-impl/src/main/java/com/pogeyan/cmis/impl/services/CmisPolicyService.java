...
public class CmisPolicyService {
	...
	public static class Impl {
		...
		public static void removePolicy(String repositoryId, String policyId, String objectId, String userName,
				String tracingId, ISpan parentSpan) throws CmisInvalidArgumentException, CmisObjectNotFoundException {
			ISpan span = TracingApiServiceFactory.getApiService().startSpan(tracingId, parentSpan,
		 ...
		 */
		public static void applyPolicy(String repositoryId, String policyId, String objectId, String tracingId,
			...
			if (null != polIds && polIds.contains(policyId)) {
				...
				TracingApiServiceFactory.getApiService().endSpan(tracingId, span);
				throw new CmisInvalidArgumentException(
						"Policy id: " + policyId + " cannot be added because it is already applied to object: " + objectId
								+ " TraceId:" + span.getTraceId());
			}
			if (polIds == null) {
